			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-4">
					      <input type="text" class="form-control form-control-sm " id="no_category" name="no_category" value="">
					    </div>
					</div>
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control form-control-sm" id="nama_category" name="nama_category" value="">
					    </div>
					</div>
				</div><!-- /.col-md-12 -->
			</div><!-- /.row -->
