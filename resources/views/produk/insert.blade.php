...
<div class="container">
	...
	<form method="post" action="{{ url('/produk/insert') }}">
	@csrf

	<div class="card mb-3">
		<div class="card-header text-bg-primary">INFORMASI PRODUK</div>
		<div class="card-body">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-4">
					      <input type="text" class="form-control form-control-sm " id="no_produk" name="no_produk" value="">
					    </div>
					</div>
					    ...
					    <div class="col-sm-8">
					      <select name="category_id" id="category_id" class="form-select form-select-sm ft-13" required>
				          	...
				          	if(count($option_category) > 0):
								...
								?>
								<option value="{!! $row->id !!}">{!! $row->no_category .' | '. $row->nama_category !!}</option>
								<?php
								endforeach;
							endif;
							?>
					...
					<div class="mb-1 row">
					    ...
					    <div class="col-sm-8">
					      <input type="text" class="form-control form-control-sm" id="nama_produk" name="nama_produk" value="">
					    </div>
					</div>
				</div><!-- /.col-md-12 -->
			</div><!-- /.row -->
