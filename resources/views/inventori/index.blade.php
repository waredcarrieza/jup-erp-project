...
<div class="container">
	<div class="row mb-2">
		<div class="col-md-4 mt-2">
			<h5>BARANG INVENTORY</h5>

			<a href="{{ url('/inventori/create') }}" class="btn btn-sm btn-primary">CREATE</a>
		</div><!-- /.col-md-1 -->
	</div><!-- /.row -->
							...
							<td class="text-center">
								<div class="btn-group dropend">
									...
									<ul class="dropdown-menu dropdown-menu-dark" style="font-size: 13px;">
										<li><a class="dropdown-item disabled">'. $row->no_inventory .'</a></li>
										<li hidden><a href="'. url('/inventori/detail/' . $row->inventory_code) .'" class="dropdown-item">Detail</a></li>
										<li><a href="'. url('/inventori/edit/' . $row->inventory_code) .'" class="dropdown-item">Edit</a></li>
    									<li><hr class="dropdown-divider"></li>
										<li><a data-url="'. url('/inventori/delete/') .'" data-id="'. $row->inventory_code .'" data-name="'. $row->no_inventory .'" class="dropdown-item text-danger btnRemoveTrans">Delete</a></li>
									</ul>
								</div>
							</td>
